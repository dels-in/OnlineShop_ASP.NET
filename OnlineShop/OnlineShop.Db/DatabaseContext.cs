    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Product>().HasData(new List<Product>
        {
            new()
            {
                ...
                Source = "/images/products/fm2024.jpg", MetacriticScore = 84, Genre = "Simulation"
            },
            new()
            {
                Id = 2,
                ...
                Source = "/images/products/zelda.jpg", MetacriticScore = 96, Genre = "Action"
            },
            new()
            {
                Id = 3,
                ...
                Source = "/images/products/sekiro.jpg", MetacriticScore = 90, Genre = "Action"
            },
            new()
            {
                Id = 4,
                ...
                Source = "/images/products/starfield.jpeg", MetacriticScore = 83, Genre = "RPG"
            },
            new()
            {
                Id = 5,
                ...
                Source = "/images/products/tetris.jpg", MetacriticScore = 78, Genre = "Puzzle"
            },
            new()
            {
                Id = 6,
                ...
                Source = "/images/products/baldursgate.jpeg", MetacriticScore = 96, Genre = "RPG"
            },
            new()
            {
                Id = 7,
                ...
                Source = "/images/products/dota2.jpg", MetacriticScore = 96, Genre = "MOBA"
            },
            new()
            {
                Id = 8,
                ...
                Source = "/images/products/rdr2.png", MetacriticScore = 97, Genre = "Action"
            },
            new()
            {
                Id = 9,
                ...
                Source = "/images/products/katana_zero.png", MetacriticScore = 83, Genre = "Platformer"
            },
            new()
            {
                Id = 10,
                ...
                Source = "/images/products/dark_souls.jpg", MetacriticScore = 84, Genre = "Souls-like"
            },
            new()
            {
                Id = 11,
                ...
                Source = "/images/products/tlou.jpeg", MetacriticScore = 95, Genre = "Action-adventure"
            },
            new()
            {
                Id = 12,
                ...
                Source = "/images/products/disco_elysium.jpeg", MetacriticScore = 91, Genre = "RPG"
            }
        });
    }
}