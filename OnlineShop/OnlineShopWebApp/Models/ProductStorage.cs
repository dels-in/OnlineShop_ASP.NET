...
public static class ProductStorage
{
    ...
    {
        new Product("Katana Zero", 999, "Katana ZERO is a stylish " +
        ...
        new Product("Sekiro", 2999, "Carve your own clever path to vengeance " +
                                    "in the award winning adventure from developer FromSoftware, " +
                                    "creators of Bloodborne and the Dark Souls series. " +
                                    "Take Revenge. Restore Your Honor. Kill Ingeniously."),
        new Product("Starfield", 5999, "In this new generation role-playing " +
                                       ...
                                       "of humanity."),
        new Product("Tetris", 499, "Connected adds an all-new robust " +
